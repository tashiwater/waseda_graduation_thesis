...
model_path = MODEL_DIR + "MTRNN/20200719_181607_7000.pth"
...
cf_states = []
cs_states = []
rate = rospy.Rate(10 * high_freq)
end_step = 100 * high_freq
motion_count = 0
...
while not rospy.is_shutdown() and motion_count < end_step:
    ...
    if motion_count % high_freq == 0:
        ...
        position = output[:7]
        position = dataset.reverse_position(position)
